...
%      ^ meta.environment.verkitim.verb.latex
%      ^ - support.function.general.latex
\verb+\command{}+
%      ^ markup.raw.verb.latex
%      ^ meta.environment.verkitim.verb.latex
...
% ^ support.function.begin.latex keyword.control.flow.begin.latex
%        ^ variable.parameter.function.latex
The \emph{verkitim} environment sets everything in verkitim.
% <- meta.environment.verkitim.verkitim.latex
% ^ markup.raw.verkitim.latex
%         ^ - markup.italic.emph.latex
\command{}
% ^ - support.function.general.latex
...
def my_function():
    pass
% <- meta.environment.verkitim.lstlisting.latex
...
\lstinline{var x = 15;}
% ^^^^^^^^^^^^^^^^^^^^^ meta.environment.verkitim.lstinline.latex
%         ^^^^^^^^^^^^^ meta.group.brace.latex
%         ^ punctuation.definition.group.brace.begin.latex
%          ^^^^^^^^^^^ markup.raw.verb.latex
%                     ^ punctuation.definition.group.brace.end.latex
...
def my_function():
    pass
% <- meta.environment.verkitim.minted.latex
% <- meta.environment.embedded.python.latex
% <- source.python.embedded
%   ^ keyword.control.flow.pass.python
\end{minted}
